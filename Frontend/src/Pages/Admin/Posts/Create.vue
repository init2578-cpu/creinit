        ...
        <div class="max-w-4xl mx-auto py-8 px-4">
            <header class="mb-8 flex items-center justify-between">
                <div>
                    ...
                    <h1 class="text-3xl font-black text-gray-900 tracking-tight">Nouvelle Publication</h1>
                </div>
            </header>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        ...
                        <input 
                            ...
                            type="text" 
                            required
                            placeholder="Ex: Lancement de la nouvelle cohorte..."
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="2"
                            placeholder="Résumé qui apparaîtra sur la carte de l'actualité..."
                    ...
                    <div class="flex items-center justify-between p-6 bg-gray-50 rounded-[1.25rem]">
                        <div>
                            <span class="block text-sm font-black text-gray-900">Publier immédiatement ?</span>
                            <span class="text-xs text-gray-500 font-medium">Si inactif, l'article sera enregistré comme brouillon.</span>
                        </div>
                        <button 
                            type="button"

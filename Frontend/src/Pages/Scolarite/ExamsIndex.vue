                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="relative w-28 group-focus-within:scale-105 transition-transform duration-300">
                                        <input 
                                            ...
                                            min="0" 
                                            :max="20"
                                            :disabled="isSecretaire || (selectedExamForGrades?.type === 'paper' && student.is_graded && !isDirecteur) || student.status === 'blocked' || student.status === 'started' || selectedExamForGrades?.type === 'online'"
                                            ...
                                            placeholder="0.00"
                                            :title="selectedExamForGrades?.type === 'online' ? 'Note calculée automatiquement pour les évaluations en ligne.' : ((student.status === 'blocked' || student.status === 'started') ? 'Terminez l\'évaluation de l\'apprenant avant de modifier la base.' : ((selectedExamForGrades?.type === 'paper' && student.is_graded && !isDirecteur) ? 'Note déjà saisie. Seul le directeur peut la modifier.' : 'Saisir la note'))"
                                        >
